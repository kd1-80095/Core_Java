...
public class EmployeeTest {
	...
	public static void main(String[] args) {
		...
		Employee e2=new Employee("Aniket","Jadhav",100000);
		e1.acceptEmployee();
		e1.displayEmployee();
		
		
		System.out.println("Annual Salary:"+e1.annualSalary());
		System.out.println("Final Salary:"+e1.annualSalary()*1.1);
		System.out.println("----------------------------------");
		e2.displayEmployee();
		System.out.println("Annual Salary:"+e2.annualSalary());
		System.out.println("Final Salary:"+e2.annualSalary()*1.1);
